...
class ClothesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothe" do
    assert_difference('Clothe.count') do
      post clothes_url, params: { clothe: { clothing_category: @clothe.clothing_category, color: @clothe.color, occasion: @clothe.occasion, quadrant: @clothe.quadrant, user_id: @clothe.user_id } }
    end
  ...
  test "should update clothe" do
    patch clothe_url(@clothe), params: { clothe: { clothing_category: @clothe.clothing_category, color: @clothe.color, occasion: @clothe.occasion, quadrant: @clothe.quadrant, user_id: @clothe.user_id } }
